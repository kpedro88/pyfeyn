:py:mod:`pyfeyn2.render.dot`
============================

.. py:module:: pyfeyn2.render.dot
...
.. autoapisummary::
   ...
   pyfeyn2.render.dot.feynman_adjust_points
   pyfeyn2.render.dot.dot_to_positions
   pyfeyn2.render.dot.dot_to_tikz
   pyfeyn2.render.dot.feynman_to_dot
...
.. autoapisummary::
   ...
   pyfeyn2.render.dot.map_feyn_to_tikz


.. py:data:: map_feyn_to_tikz
   

   

.. py:function:: feynman_adjust_points(feyndiag, size=5)


.. py:function:: dot_to_positions(dot)


.. py:function:: dot_to_tikz(dot)


.. py:function:: feynman_to_dot(fd)


.. py:class:: DotRender(fd, documentclass='standalone', document_options=['preview', 'crop', 'tikz'], *args, **kwargs)
